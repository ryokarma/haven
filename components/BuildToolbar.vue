...
<template>
  <div class="hidden md:flex fixed bottom-4 left-1/2 -translate-x-1/2 bg-stone-900/90 border border-stone-700 rounded-xl p-2 items-center gap-2 shadow-xl backdrop-blur-sm z-10 pointer-events-auto" @click.stop @pointerdown.stop @mousedown.stop @touchstart.stop>
